...
const corsOptions = {
  origin: ["https://shipduniya.in","http://localhost:3000"],
  credentials: true,
...
const extraWeightRoutes = require("./routes/extraWeightRoutes");
...
app.use("/api/weightReconciliation", extraWeightRoutes);
