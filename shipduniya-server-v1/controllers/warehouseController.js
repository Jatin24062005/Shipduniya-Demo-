...
const editWarehouse = async (req, res) => {
  try {
    ...
    const { name, address, pincode, capacity, managerName, managerMobile } = req.body;
    ...
    // Optionally, ensure the user is authorized to update this warehouse
    // (for example, you can check if the user owns the warehouse)
    ...
    if (pincode) warehouse.pincode = pincode;
