...
export default function RootLayout({ children }) {
  ...
  const navItems = useMemo(
    () => [
      { name: "Dashboard", icon: LayoutDashboard, url: "/user/dashboard" },
      { name: "Orders", icon: Package, url: "/user/orders" },
      { name: "Shipments", icon: Ship, url: "/user/shipments" },
      { name: "NDR", icon: Cross, url: "/user/ndrs" },
      { name: "Tickets", icon: Ticket, url: "/user/tickets" },
      { name: "Transactions", icon: ArrowLeftRight, url: "/user/transactions" },
      { name: "Remittance", icon: ArrowRight, url: "/user/cod-remittance" },
      { name: "Calculate", icon: CalculatorIcon, url: "/user/calculator" },
      { name: "Settings", icon: Settings, url: "/user/settings" },
    ],
    []
  );
