...
export default function RootLayout({ children }) {
  ...
  const navItems = useMemo(
    () => [
      ...
      { name: "Users", icon: Users, url: "/superadmin/users" },
      { name: "Staff", icon: Users, url: "/superadmin/staff" },
      { name: "Shipments", icon: Ship, url: "/superadmin/shipments" },
      { name: "NDR", icon: Ship, url: "/superadmin/ndrs" },
      { name: "Analytics", icon: Cross, url: "/superadmin/analytics" },
      {
        name: "Remittance",
        icon: ArrowRight,
        url: "/superadmin/cod-remittance",
      },
      {
        name: "Transactions",
        icon: ArrowLeftRight,
