...
export default function EditBulkUploadComponent({ isOpen, setIsOpen, onUpload }) {
  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      const response = await onUpload(file,orders);
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload your Excel file for Edit bulk data.
          </DialogDescription>
        </DialogHeader>
