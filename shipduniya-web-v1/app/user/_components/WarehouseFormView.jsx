...
const warehouseFormSchema = z.object({
  ...
  managerName: z
    ...
    .max(20, {
      message: "Manager's name must be no more than 50 characters long",
    }),
  managerMobile: z
    .string()
  ...
  status: z.enum(["operational", "under maintenance"], {
    errorMap: () => ({
      message: "Status must be either 'operational' or 'under maintenance'",
    }),
